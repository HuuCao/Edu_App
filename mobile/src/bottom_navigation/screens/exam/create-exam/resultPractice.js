...
const ResultPracticeScreen = ({navigation, route}) => {
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#FFFFFF'}}>
      <TouchableOpacity
        ...
        <Text style={{fontSize: 20, fontWeight: '600'}}>Hoàn thành bài</Text>
      </TouchableOpacity>
      <ScrollView>
        ...
        {/* <View style={{alignItems: 'center', marginVertical: 50}}>
          <Text style={{fontSize: 20}}>
            {'Bạn thường hay sai câu dể cần chú ý hơn'}
          </Text>
        </View> */}
...
export default ResultPracticeScreen;
